---
layout: post
title: Convert FT2232HL break-out board to Digilent USB JTAG Adapter
...
The high level steps necessary to accomplish this are:
...
<p align="center">
<img width="200" src="../img/ft2232hl_bob_front.jpg">
<img width="200" src="../img/ft2232hl_bob_back.jpg")
</p>
...
<p align="center">
<img width="200" src="../img/ft2232hl_bob_hdrs.jpg">
</p>
...
NOTE: If you want/need to build libftdi from scratch follow the instructions here.
...
The program 'dadutil' is part of the AUR Digilent package installation.
```
