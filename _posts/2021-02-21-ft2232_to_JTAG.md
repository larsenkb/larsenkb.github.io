...
If you want to add a UART interface to the 2nd channel of the BoB, then you need to patch 3 bytes show in the table below into the ft2232hl_bob_new.bin file and flash the eeprom again.
